...
module Test::Unit::Assertions
  ...
  # @return [void]
  #
  # source://test-unit//lib/test/unit/assertions.rb#1841
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1495
  def assert_alias_method(object, alias_name, original_name, message = T.unsafe(nil)); end

  # @overload assert_all
  # @since 3.4.4
  #
  # source://test-unit//lib/test/unit/assertions.rb#1705
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1266
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1315
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1640
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1348
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1298
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1049
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1579
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1427
  ...
  #   assert_not_empty({})                       # -> fail
  #
  # source://test-unit//lib/test/unit/assertions.rb#1663
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#949
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1080
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1606
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1466
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1231
  def assert_not_send(send_array, message = T.unsafe(nil)); end

  # @overload assert_nothing_leaked_memory
  # @since 3.4.5
  #
  # source://test-unit//lib/test/unit/assertions.rb#1779
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1542
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1560
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1444
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1372
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1191
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#1282
  ...
  # the template.
  #
  # source://test-unit//lib/test/unit/assertions.rb#1812
  ...
  # source://test-unit//lib/test/unit/assertions.rb#987
  ...
  class << self
    ...
    #
    # source://test-unit//lib/test/unit/assertions.rb#1847
...
class Test::Unit::Assertions::AssertExceptionHelper
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2340
  def initialize(test_case, expected_exceptions); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2362
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2406
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2416
  def expected_class?(actual_exception, equality); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2422
  def expected_module?(actual_exception); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2428
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2370
  def split_expected_exceptions(expected_exceptions); end
end

# source://test-unit//lib/test/unit/assertions.rb#2302
class Test::Unit::Assertions::AssertExceptionHelper::WrappedException
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2304
  def initialize(exception); end

  # Returns the value of attribute exception.
  #
  # source://test-unit//lib/test/unit/assertions.rb#2303
  def exception; end

  # source://test-unit//lib/test/unit/assertions.rb#2308
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/assertions.rb#2328
  def default_inspect?; end
end

# source://test-unit//lib/test/unit/assertions.rb#1888
class Test::Unit::Assertions::AssertionMessage
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2269
  def convert(object); end

  # source://test-unit//lib/test/unit/assertions.rb#2273
  def template; end

  # source://test-unit//lib/test/unit/assertions.rb#2284
  def to_s; end
  ...
  class << self
    # source://test-unit//lib/test/unit/assertions.rb#1979
    def convert(object); end

    # source://test-unit//lib/test/unit/assertions.rb#1956
    def delayed_diff(from, to); end

    # source://test-unit//lib/test/unit/assertions.rb#1897
    def delayed_literal(&block); end

    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/assertions.rb#1925
    def diff_target_string?(string); end

    # source://test-unit//lib/test/unit/assertions.rb#1933
    def ensure_diffable_string(string); end

    # source://test-unit//lib/test/unit/assertions.rb#1893
    def literal(value); end

    # source://test-unit//lib/test/unit/assertions.rb#1906
    def max_diff_target_string_size; end

    # source://test-unit//lib/test/unit/assertions.rb#1921
    def max_diff_target_string_size=(size); end

    # source://test-unit//lib/test/unit/assertions.rb#1901
    def maybe_container(value, &formatter); end

    # source://test-unit//lib/test/unit/assertions.rb#1941
    def prepare_for_diff(from, to); end

    # Returns the value of attribute use_pp.
    #
    # source://test-unit//lib/test/unit/assertions.rb#1891
    def use_pp; end
...
class Test::Unit::Assertions::AssertionMessage::DelayedLiteral
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2191
...
# source://test-unit//lib/test/unit/assertions.rb#2089
...
class Test::Unit::Assertions::AssertionMessage::Inspector
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2022
  def object; end

  # source://test-unit//lib/test/unit/assertions.rb#2035
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2039
  def pretty_print_cycle(q); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#2052
  def inspect_target; end

  class << self
    # source://test-unit//lib/test/unit/assertions.rb#2003
    def cached_new(object, inspected_objects); end

    # source://test-unit//lib/test/unit/assertions.rb#2009
...
class Test::Unit::Assertions::AssertionMessage::MaybeContainer
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2201
  def initialize(value, &formatter); end

  # source://test-unit//lib/test/unit/assertions.rb#2206
  def inspect; end
end

# source://test-unit//lib/test/unit/assertions.rb#2062
class Test::Unit::Assertions::AssertionMessage::NumericInspector
  ...
  # source://test-unit//lib/test/unit/assertions.rb#2076
  def inspect; end

  # source://test-unit//lib/test/unit/assertions.rb#2080
  def pretty_print(q); end

  # source://test-unit//lib/test/unit/assertions.rb#2084
  def pretty_print_cycle(q); end
...
class Test::Unit::Assertions::AssertionMessage::Template
  ...
  #
  # source://test-unit//lib/test/unit/assertions.rb#2224
  def count; end

  # source://test-unit//lib/test/unit/assertions.rb#2231
  def result(parameters); end

  private

  # source://test-unit//lib/test/unit/assertions.rb#2252
...
module Test::Unit::Attribute
  ...
  # source://test-unit//lib/test/unit/attribute.rb#222
  def [](name); end

  # source://test-unit//lib/test/unit/attribute.rb#218
  def attributes; end
...
module Test::Unit::Attribute::ClassMethods
  ...
  # source://test-unit//lib/test/unit/attribute.rb#213
  ...
  # source://test-unit//lib/test/unit/attribute.rb#207
...
class Test::Unit::ColorScheme
  ...
  # source://test-unit//lib/test/unit/color-scheme.rb#176
  def [](name); end

  # source://test-unit//lib/test/unit/color-scheme.rb#180
  def []=(name, color_spec); end

  # source://test-unit//lib/test/unit/color-scheme.rb#184
  def each(&block); end

  # source://test-unit//lib/test/unit/color-scheme.rb#188
  def to_hash; end
  ...
  class << self
    ...
    # source://test-unit//lib/test/unit/color-scheme.rb#148
    def guess_available_colors_from_colorterm_env; end

    # source://test-unit//lib/test/unit/color-scheme.rb#157
    def guess_available_colors_from_term_env; end

    # source://test-unit//lib/test/unit/color-scheme.rb#133
