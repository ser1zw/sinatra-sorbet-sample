...
# source://power_assert//lib/power_assert/inspector.rb#5
class PowerAssert::InspectedValue
  # @return [InspectedValue] a new instance of InspectedValue
  #
  # source://power_assert//lib/power_assert/inspector.rb#6
  def initialize(value); end

  # source://power_assert//lib/power_assert/inspector.rb#10
  def inspect; end
end

# source://power_assert//lib/power_assert/inspector.rb#38
class PowerAssert::Inspector
  # @return [Inspector] a new instance of Inspector
  #
  # source://power_assert//lib/power_assert/inspector.rb#39
  def initialize(value, indent); end

  # source://power_assert//lib/power_assert/inspector.rb#44
  def inspect; end
end
...
# source://power_assert//lib/power_assert/inspector.rb#16
class PowerAssert::SafeInspectable
  # @return [SafeInspectable] a new instance of SafeInspectable
  #
  # source://power_assert//lib/power_assert/inspector.rb#17
  def initialize(value); end

  # source://power_assert//lib/power_assert/inspector.rb#21
  def inspect; end
end
